...
Please make a frequency histogram from the following (unsorted) continuous data by rounding to the nearest integer.
...
hist(dd,breaks=c(value-0.5,max(value)+0.5),main="Histogram",xlab="Value")
```
\

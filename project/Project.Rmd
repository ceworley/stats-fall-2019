...
You will do original research, write a paper summarizing the research, and present the research with slides.
...
* Characterize a distribution (histogram, mean [with confidence interval], standard deviation)
...
* Times between drops of a slowly leaking faucet
* Sums of $n$ dice

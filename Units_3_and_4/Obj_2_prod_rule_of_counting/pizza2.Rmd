...
`r na` is buying a pizza. `r na` still has to decide on a `r it[1]` and a `r it[2]`. The shop carries `r ns[1]` `r its[1]` and `r ns[2]` `r its[2]`. How many different combinations is `r na` choosing between?

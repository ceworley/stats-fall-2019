...
if(qn == 1){
  ...
  q=paste("A pizza place has",n,"toppings available. Brenda will order a pizza with",x,"toppings. How many different pizzas is Brenda choosing between?")
} else if (qn == 11) {
  q=paste("Joe is shopping for shirts. Joe likes",n,"of the shirts, but will only buy",x,"of them. How many different combinations of shirts are possible?")
}

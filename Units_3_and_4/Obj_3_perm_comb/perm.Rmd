...
if(qn == 1){
  ...
  days = c("Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday")
  ds = days[1:x]
  q=paste("Jason needs to wear a different shirt every day he works: ",lto(ds),". Jason has ",n," shirts to choose from. How many different shirt schedules are possible?",sep="")
} else if (qn == 11) {
  ps = sample(c("fanciest","most original","prettiest",
                "ugliest","scariest","funniest"),x)
  q = paste("A costume party judge needs to choose winners of the following prizes: ",lto(ps),". There are ",n," people at the party. How many possibilities exist?",sep="")
}

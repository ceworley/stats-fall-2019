...
\
\newline
You should count about `r round(2-2*pnorm(z),2)*100` shaded squares, giving a probability of about `r round(2-2*pnorm(z),2)`.
* The probability is `r round(2-2*pnorm(z),4)`. 

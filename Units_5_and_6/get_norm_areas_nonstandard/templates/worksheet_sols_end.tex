...
%% new environments
\newenvironment{question}{\begin{minipage}{\linewidth} \item \textbf{Problem}\newline}{\end{minipage}\vfill}
...
\renewenvironment{solution}{\begin{minipage}{\linewidth} \item }{\end{minipage}\vfill}

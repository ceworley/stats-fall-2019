...
Answerlist
--------
* Estimate $z$ such that $P(Z>z) = `r round(1-pnorm(z),2)`$ by shading and counting.
* Determine $z$ such that $P(Z>z) = `r round(1-pnorm(z),2)`$ by using the $z$-table.
...
\
\newline
When you have shaded `r round(1-pnorm(z),2)*100` squares, starting on the right, you should end around $z = `r z`$.
* $z = `r round(qnorm(round(1-pnorm(z),2)),2)`$

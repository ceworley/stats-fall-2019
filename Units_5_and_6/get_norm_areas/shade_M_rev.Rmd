...
* Estimate $z$ such that $P(|Z|<z) = `r round(2*pnorm(z)-1,2)`$ by shading and counting.
* Determine $z$ such that $P(|Z|<z) = `r round(2*pnorm(z)-1,2)`$ by using the $z$-table.
...
\
\newline
When you have shaded `r round(2*pnorm(z)-1,2)*100` squares, starting in the middle, you should end near $z=`r z`$.
* $z=`r round(qnorm(round(2*pnorm(z)-1,2)),2)`$

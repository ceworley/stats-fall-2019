...
$$x = `r x[is[2]]`$$
* The mean is $\frac{`r sum(x)`}{`r n`} = `r mean(x)`$
* If $n$ is odd, then median is $x_{\frac{n+1}{2}}$, the value of $x$ when $i=\frac{n+1}{2}$. Otherwise median is mean of $x_{\lfloor \frac{n+1}{2} \rfloor}$ and $x_{\lceil \frac{n+1}{2} \rceil}$. So, median = $`r median(x)`$.

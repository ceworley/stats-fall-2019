...
$$z^\star = `r zstar` $$
Estimate the standard error. (The standard error is the standard deviation of the sampling distribution.)
$$\sigma_{\hat{p}} = \sqrt{\frac{\hat{p}(1-\hat{p})}{n}} = \sqrt{\frac{(`r phat`)(1-`r phat`)}{`r n`}} = `r se` $$
Calculate the margin of error.
$$ME ~=~ z^\star \sigma_{\hat{p}} ~=~ (`r zstar`)(`r se`) ~=~ `r signif(zstar*se,3)` $$

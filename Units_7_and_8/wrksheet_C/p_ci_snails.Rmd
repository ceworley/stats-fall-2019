...
Some snails have clockwise shells, and others have counter-clockwise shells. In a random sample of `r n` snails, there were `r sucs` snails with clockwise shells.  Construct a `r CL*100`% confidence interval of the population proportion with clockwise shells.

...
A population has unknown $\mu$ but a known $\sigma = `r sig`$. A sample of size `r n` has a mean $\bar{x}=`r xbar`$. Determine the `r cl*100`% confidence interval of the population mean.

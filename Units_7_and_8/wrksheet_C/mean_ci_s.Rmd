...
A population has unknown $\mu$ and unknown $\sigma$. A sample of size `r n` has a mean $\bar{x}=`r xbar`$ and a standard deviation $s=`r s`$. Determine the `r cl*100`% confidence interval of the population mean.

...
Some snails have clockwise shells, and others have counter-clockwise shells.  You want to construct a `r CL*100`% confidence interval of the population proportion with clockwise shells. You hope the margin of error will be about `r ME`. You already know that the proportion with clockwise shells is near `r p`. How many snails do you need?

...
A new virus has been devastating corn production. When exposed, `r p*100`% of common seedlings survive. We are trying to develop a resistant strain of corn.

When we expose `r n` seedlings of our strain to the virus, `r phat*100`% survive. Using a significance level of `r alpha`, can we conclude that our strain is significantly more resistant?
...
This is a right-tail (one-tail) proportion test because we only care whether a higher percentage of seedlings survive.

...
Solution
========
A right-tail proportion test is appropriate. State the hypotheses.
...
Answerlist
--------
* A right-tail (one-tail) proportion test is appropriate.
* Hypotheses: $H_0\text{ claims }p=`r p`$ and $H_A\text{ claims }p>`r p`$.
* The $p$-value is `r Pr`

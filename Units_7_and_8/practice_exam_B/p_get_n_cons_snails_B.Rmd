...
Some snails have clockwise shells, and others have counter-clockwise shells. You plan to estimate the proportion with clockwise shells by sampling. You want to be `r CL*100`% confident that the sample proportion is within `r ME` of the population proportion. How many snails do you need?

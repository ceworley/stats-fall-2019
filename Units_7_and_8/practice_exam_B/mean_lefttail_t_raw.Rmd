...
A null hypothesis claims a population has a mean $\mu = `r mu`.0$. You decide to run left-tail test on a sample of size $n=`r n`$ using a significance level $\alpha = `r alpha`$. 
